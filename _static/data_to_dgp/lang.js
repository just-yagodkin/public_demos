const langArr = {
    ...
    "DtText":{
        "ru": `Выберите (нажмите) ребра следующим образом: оставьте его пунктирным, если одна переменная не влияет на другую переменную, или сделайте его сплошным, если есть.
